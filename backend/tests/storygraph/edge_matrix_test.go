...
func TestStoryGraphEdgeMatrixCoversEveryCanonicalRelationship(t *testing.T) {
	cases := []struct {
		...
		{"precedes", storygraph.EdgeTypePrecedes, storygraph.NodeTypeScene, storygraph.NodeTypeScene, storygraph.EdgeQualifier{SequenceKey: "episode/1/scenes"}, storygraph.NodeTypeAssetIdentity, storygraph.NodeTypeAssetIdentity},
