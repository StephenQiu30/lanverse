...
func TestArtifactReadinessPersistsOneOwnerFactWithRealPostgreSQLAndMinIO(t *testing.T) {
	...
	if err = database.Create(&model.Project{ID: projectID, WorkspaceID: workspaceID, Name: "Asset Project", AspectRatio: "9:16", Language: "zh-CN", TargetDurationMS: 60000, BudgetLimit: decimal.Zero, Currency: "CNY", Status: "active", Revision: 1, CreatedAt: now, UpdatedAt: now}).Error; err != nil {
