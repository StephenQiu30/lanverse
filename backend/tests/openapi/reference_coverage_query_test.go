...
func TestReferenceCoverageQueriesAreTypedReadOnlySnapshots(t *testing.T) {
	...
	checks := []struct {
		...
		{"/api/projects/{project_id}/reference-executions/{execution_id}/bundle-inputs", []string{"#/components/parameters/project_id", "#/components/parameters/execution_id"}, "#/components/schemas/ReferenceBundleInputsResponse"},
