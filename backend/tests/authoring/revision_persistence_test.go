...
func seedAuthoringProject(t *testing.T, create func(any) error, now time.Time) authoringFixture {
	...
	records := []any{
		...
		&model.Project{ID: projectID, WorkspaceID: workspaceID, Name: "Authoring Project", AspectRatio: "9:16", Language: "zh-CN", TargetDurationMS: 90_000, BudgetLimit: decimal.Zero, Currency: "CNY", Status: "active", Revision: 1, CreatedAt: now, UpdatedAt: now},
