...
async def archive_project(
    ...
    return ApiResponse(
        data=await service.set_archived(
            session, claims, project_id, payload, archived=True
        )
    )
...
async def restore_project(
    ...
    return ApiResponse(
        data=await service.set_archived(
            session, claims, project_id, payload, archived=False
        )
    )
...
async def create_episode(
    ...
    return ApiResponse(
        data=await service.create_episode(session, claims, project_id, payload)
    )
...
async def reorder_episodes(
    ...
    return ApiResponse(
        data=await service.reorder_episodes(session, claims, project_id, payload)
    )
...
async def archive_episode(
    ...
    return ApiResponse(
        data=await service.set_episode_archived(
            session, claims, episode_id, payload, archived=True
        )
    )
...
async def episode_delete_preflight(
    ...
    return ApiResponse(
        data=await service.episode_delete_preflight(session, claims, episode_id)
    )
