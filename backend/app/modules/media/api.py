...
async def initialize_upload(
    ...
    return ApiResponse(
        data=await service.initialize_upload(session, claims, payload, storage, settings)
    )
...
async def list_media_locations(
    ...
    return ApiResponse(data=await service.list_media_locations(session, claims, version_id))
...
async def create_access(
    ...
    return ApiResponse(
        data=await service.create_access(session, claims, version_id, payload, storage, settings)
    )
