...
class StoryboardExportManifest(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint("id", "workspace_id", name="uq_sbd_export_manifest_workspace"),
        UniqueConstraint("job_id", name="uq_sbd_export_manifest_job"),
        UniqueConstraint("media_version_id", name="uq_sbd_export_manifest_media"),
        Index("ix_sbd_export_manifest_episode_created", "episode_id", "created_at"),
    )
