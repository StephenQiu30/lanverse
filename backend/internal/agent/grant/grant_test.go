...
func TestGrantBindsInvocationAndExpires(t *testing.T) {
	...
	invocation := contract.Invocation{InvocationID: "00000000-0000-0000-0000-000000000001", Kind: "production_bible", InputHash: "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", SchemaVersion: contract.SchemaVersion, Payload: json.RawMessage(`{}`)}
