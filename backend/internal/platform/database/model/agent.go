...
type ShardManifest struct {
	...
	Stage              string            `gorm:"type:varchar(40);not null;uniqueIndex:uq_agt_manifest_node_stage_version,priority:3;check:ck_agt_manifest_stage,stage IN ('extract_source_evidence','analyze_story','reconcile_story','review_storygraph','segment_episodes','analyze_episode','reconcile_episode','draft_storyboard','propose_script_spans','extract_scene_facts','resolve_identities','review_candidate')"`
