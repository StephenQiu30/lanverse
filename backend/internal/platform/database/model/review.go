...
type HumanTask struct {
	...
	Status          string         `gorm:"type:varchar(20);not null;index:ix_rev_tasks_workspace_status_updated,priority:2;index:ix_rev_tasks_project_status_updated,priority:2;check:ck_rev_task_status,status IN ('OPEN','CLAIMED','COMPLETED','CANCELLED')"`
