...
type WorkflowHumanGateApplyReceipt struct {
	...
	DecisionPayloadHash string            `gorm:"type:char(64);not null;default:'44136fa355b3678a1146ad16f7e8649e94fb4fc21fe77e8310c060f61caaff8a';check:ck_wrk_gate_apply_decision_payload_hash,char_length(decision_payload_hash) = 64"`
...
type WorkflowSignalIntent struct {
	...
	DecisionPayloadHash string                        `gorm:"type:char(64);not null;default:'44136fa355b3678a1146ad16f7e8649e94fb4fc21fe77e8310c060f61caaff8a';check:ck_wrk_signal_decision_payload_hash,char_length(decision_payload_hash) = 64"`
