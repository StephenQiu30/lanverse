...
func TestLoadFromDotEnvFile(t *testing.T) {
	...
	if cfg.Env != "prod" || cfg.HTTPAddr != ":9011" || cfg.LogLevel != "warn" || cfg.DBDSN != "postgres://local/db" {
...
func TestLoadFromEnv(t *testing.T) {
	...
	want := Config{Env: "staging", HTTPAddr: ":9090", LogLevel: "debug", DBDSN: "postgres://localhost/lanverse"}
	if cfg != want {
