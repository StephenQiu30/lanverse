...
func TestLoadFromDotEnvFile(t *testing.T) {
	...
	if cfg.Env != "prod" || cfg.HTTPAddr != ":9011" || cfg.LogLevel != "warn" || cfg.DBDSN != "postgres://local/db" || cfg.RedisURL != "redis://127.0.0.1:6379/2" {
...
func TestLoadFromEnv(t *testing.T) {
	...
	want := Config{Env: "staging", HTTPAddr: ":9090", LogLevel: "debug", DBDSN: "postgres://localhost/lanverse", RedisURL: "redis://localhost:6379/1"}
	if cfg != want {
