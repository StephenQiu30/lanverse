...
export function ProposalReview({ proposal, proposals, projectId, canWrite }: {
  ...
  return <article aria-label="提案审阅" className="min-w-0 space-y-6 bg-transparent">
    ...
    </section> : <p className="pt-4 text-sm text-muted-foreground">当前为只读权限，可查看候选和已保存回执。</p>}
