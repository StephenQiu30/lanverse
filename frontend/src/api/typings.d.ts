...
declare global {
  namespace API {
    ...
    type ReferenceCandidateSetRequest = components["schemas"]["ReferenceCandidateSetRequest"];
    type ReferenceCandidateSetResponse = components["schemas"]["ReferenceCandidateSetResponse"];
