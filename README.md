...
选型与各中间件职责见 [0301 技术选型决策](docs/design/0301-技术选型决策.md)，工程约定见 [PROJECT.md](PROJECT.md)。

## 文档

| 文件 | 内容 |
| --- | --- |
| [docs/README.md](docs/README.md) | 文档中心、编号规则 |
| [0101 产品定义与需求分析](docs/design/0101-产品定义与需求分析.md) | 产品决策、业务流程、带验收标准的需求、MVP 定义 |
| [0102 LibTV 能力调研与核心能力评估](docs/design/0102-LibTV能力调研与核心能力评估.md) | 竞品能力与实现设计、核心能力取舍、顶层架构要求 |
| [0201 系统架构设计](docs/design/0201-系统架构设计.md) | 顶层原则、领域模型、Operation、Temporal 工作流、Agent Harness、事件、画布、扩展点 |
| [0301 技术选型决策](docs/design/0301-技术选型决策.md) | 前端、后端、Agent、工作流、中间件、模型的明确选型 |
| [0401 实施路线与交付计划](docs/design/0401-实施路线与交付计划.md) | P0 与 M1–M4、验收、人力、风险 |
