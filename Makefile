.PHONY: test-architecture test-database-design test-migration test-contract-foundation contracts-check test-jobs test-e2e test lint typecheck build build-images
