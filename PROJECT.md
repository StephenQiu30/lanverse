...
> 目标规范，2026-09-25 按从零重新设计的 [0201 系统架构](docs/design/0201-系统架构设计.md) 与 [0301 技术选型](docs/design/0301-技术选型决策.md) 重写，随 0101–0401 一同评审。
...
7. 付费调用的状态机、`unknown` 对账、费用预留与结算遵循 [0201 §5.2](docs/design/0201-系统架构设计.md#52-生成任务阶段-4678-共用)。
