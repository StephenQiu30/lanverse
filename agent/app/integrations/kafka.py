...
async def _run_handler_while_polling(
    ...
    *,
    ...
    handler_task: asyncio.Task[object] = asyncio.create_task(_invoke_handler(handler, message))
    ...
    try:
        ...
        resumable = tuple(partition for partition in paused_here if partition in current_assignment)
        if resumable:
