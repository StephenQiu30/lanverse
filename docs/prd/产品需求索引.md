...
- 状态：proposed（S0 accepted；S1 所需范围局部 accepted）
- 日期：2026-07-27
...
| [PRD-007 基础业务模块 PRD 任务](./007-基础业务模块PRD任务.md) | identity、projects、media、governance 的产品任务、依赖和逐项验收 | PT-IDN-001～004、PT-PRJ-001～003 ready |
...
- 本组文档的全量状态仍为 `proposed`；D-001 已局部接受 PRD-001/002/003 中 S0 范围、非目标、工程边界、fixture 和门禁，并允许领取 [PLAN-000](../plan/000-MVP全栈实施总计划.md) 的 `DEV-S0-01`。该局部接受不改变任何 PT 的产品状态，也不得一次预建 S1–S6 空代码目录。
