...
- 本组文档的全量状态仍为 `proposed`，因为 S2～S6 尚未接受；S0/S1 的精确接受范围与证据分别记录在 [工程基线验收](../acceptance/001-工程基线验收.md) 和 [账号与项目立项验收](../acceptance/002-账号与项目立项验收.md)。该切片接受不等于一次冻结未来模块，也不得预建 S2～S6 空代码目录。
