...
| D-005 | blocked | 上线地区、授权模板、审核责任、内容检查、标识和留存 | 产品/合规 | S2/S5 | [DES-005 中国大陆候选基线与关闭清单](../design/005-S2供应商与合规准入设计.md)：脱敏授权样例和留存/删除候选矩阵已形成；缺首发地区、责任人、模板/策略签认及最终期限或删除触发条件 |
