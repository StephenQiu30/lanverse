...
根 Makefile 由本地/CI 共用：`setup`、`dev-api`、`dev-frontend`、`db-init`、`generate-api`、`lint`、`typecheck`、`test`、`check`、`docker-build`、`business-up/down`、`env-up/down`、`e2e-install`、`e2e`。Scheduler/Worker 出现真实入口后才增加对应命令，不创建占位目标。
