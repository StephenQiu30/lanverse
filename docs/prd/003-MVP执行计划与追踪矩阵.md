...
| D-004 | open（方向已选） | Image/Video/Speech Provider、参数、取消/查询能力和单价 | 产品/AI | S4 | Image=火山方舟 Seedream、Video=火山方舟 Seedance；仍需真实账号、精确模型/地域/额度/参数/查询取消回调/价格样例；Speech/Audio 待选 |
