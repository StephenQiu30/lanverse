...
| D-004 | open（公开契约已收窄） | Image/Video Provider、参数、取消/查询能力和计价 | 产品/AI | S4 | 唯一候选为方舟北京地域的 `doubao-seedream-5-0-lite-260128`/`doubao-seedance-2-0-260128`，候选 SDK 为 `volcengine-python-sdk[ark]==5.0.43`；仍需 `ARK_API_KEY`、账号权限/额度/并发、逐参数、取消/回调竞态和真实账单样例。AI Speech/Audio 不在当前范围 |
