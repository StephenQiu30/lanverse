...
| A 手工事实主线 | M01—M05、M07—M09、M11、M14 | PRD-A | PLAN-A | 进行中：剧本解析草稿/批准、canonical GORM 物化、人物×集数与资产投影、内存 Access Token/HttpOnly refresh 已可用并完成 production 浏览器闭环；会话/路径/直接表租户边界基础已落地，跨租户/Worker/媒体对象负向验收、导入格式扩展、检索、完整镜头、交付预演待实现 |
