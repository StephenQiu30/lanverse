...
> 规范化事实来源：产品范围与发布门见[产品范围与验收基线](../prd/0001-产品范围与验收基线.md)，可测试跨服务契约见[平台 V1 需求规格](../requirement/0001-平台V1需求规格.md)，从零实施顺序见[平台 0→1 交付计划](../plan/0007-平台0到1交付计划.md)。本设计不以任何既有代码、目录或测试作为方案输入和完成证据。
