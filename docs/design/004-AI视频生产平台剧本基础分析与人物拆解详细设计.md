...
> 范围：M03 导入与叙事理解，以及 M04 中人物身份、资料、状态、关系和连续性部分
...
本设计当前不覆盖 KNO-FR-004/005 的地点与道具详细模型、KNO-FR-009 的完整世界/风格规则、KNO-FR-014/015 的组织发布和批量传播；这些能力在进入实现前必须形成后续 M04 详细 Design，不能从本文件推断为已设计完成。本表只表示覆盖关系，不表示 Requirement 已接受或验收已经执行。
