...
- 评审规则：0010（`SG-D01`）已接受，本提案现进入 `SG-D02` 独立评审。`SG-D02` 接受前不移动目录、不修改 Execution Policy、不新增 Invocation Kind，也不建立兼容入口；后续只引用文档中心 `SG-Dxx` 与 0010 `SG-Ixx` 唯一顺序
