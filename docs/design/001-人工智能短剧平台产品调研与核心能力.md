...
| 剧本格式解析 | [Fountain parser 与回归剧本](https://github.com/nyousefi/Fountain/tree/c09b65e9d4bf6cb1c672501f793b9b3f2becd452/FountainTests)、[Unstructured text/md partition](https://github.com/Unstructured-IO/unstructured/tree/114a1d511df49e8680e9608b14ee85dbd2c480dd/unstructured/partition) | 场景标题、对白、动作等应使用确定性解析和真实格式 fixture；通用文档解析需按格式隔离 | MVP 仍只做有界 UTF-8 txt/md，不引入重型 ETL；从 Fountain 借鉴格式 corpus，未来 `.fountain` 另立范围 | MIT / Apache-2.0；当前只参考 |
