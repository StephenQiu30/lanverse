...
- 状态：proposed
- 日期：2026-07-26
- 输入：`001-product-research-and-capabilities.md`
- 输出：目标架构、模块边界、目录、数据与技术选择
- 下游：MVP PRD、实施 Plan、架构约束测试
