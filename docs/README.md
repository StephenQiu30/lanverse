...
| `VP-D12` | [1002 Frontend 功能](design/1002-前端功能模块设计.md) | **当前步骤**：固定 Guided Studio、五 Gate 时间线、覆盖矩阵、候选对比和影响抽屉 | 不实现新页面；独立评审与提交前不进入 `VP-D13` |
...
| `0011` | 剧本视觉生产工作台与世界观预设 | — | [跨服务产品设计](design/0011-剧本视觉生产工作台与世界观预设设计.md) | — | — | — | 已接受目标（2026-08-30）；`VP-D01`–`VP-D11` 已完成，当前只解锁 `VP-D12`，不表示已实现 |
