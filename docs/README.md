...
| `VP-D10` | [2051 Generation](design/2051-通用媒体Provider与Generation执行器设计.md) | **当前步骤**：以 `approved_reference_plan` 严格 Target 取代旧 Storyboard Intent 来源，固定六类基础/组合输出与 Selection 交接 | 不改 Generation 代码；独立评审与提交前不进入 `VP-D11` |
...
| `0011` | 剧本视觉生产工作台与世界观预设 | — | [跨服务产品设计](design/0011-剧本视觉生产工作台与世界观预设设计.md) | — | — | — | 已接受目标（2026-08-30）；`VP-D01`–`VP-D09` 已完成，当前只解锁 `VP-D10`，不表示已实现 |
...
| `2051` | 通用媒体 Provider 与 Generation 执行器 | — | [通用媒体 Provider 与执行器设计](design/2051-通用媒体Provider与Generation执行器设计.md) | — | — | — | `VP-D10` 当前同步 ApprovedReferencePlan 六类 Target、基础/组合 Artifact 输出与 Selection 交接；既有 Provider/Secret 事实保留，不抵扣新目标 |
