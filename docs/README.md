...
| `SG-D18` | [0010 跨服务 Requirement](requirement/0010-StoryGraph内容图与DAG创作画布需求规格.md) | **当前唯一激活（2026-08-29）**：重写 Runware/环境变量目标合同并增加精确 Provider 恢复、Secret、视频与 Binding 契约 | 完成并重新接受前不复核 `SG-D19`、不编码 |
...
| `2051` | 通用媒体 Provider 与 Generation 执行器 | — | [通用媒体 Provider 与执行器设计](design/2051-通用媒体Provider与Generation执行器设计.md) | — | — | — | Design/PRD 已重新接受；等待 `SG-D18`–`SG-D21`，编码仍暂停 |
