...
| `VP-D07` | [3003 Agent/Harness](design/3003-StoryGraph剧本解析Harness与内置Skill设计.md) | **当前步骤**：定义 `storygraph-stage-wire-v2`、固定 Skill Release 与新 Stage DAG | 不修改 Go/Python Wire 或 Bundle，独立评审与提交前不进入 `VP-D08` |
...
| `0011` | 剧本视觉生产工作台与世界观预设 | — | [跨服务产品设计](design/0011-剧本视觉生产工作台与世界观预设设计.md) | — | — | — | 已接受目标（2026-08-30）；`VP-D01`–`VP-D06` 已完成，当前只解锁 `VP-D07`，不表示已实现 |
