...
| `VP-D15` | [0010 唯一 Plan](plan/0010-StoryGraph内容图与DAG创作画布实施计划.md) 与 [Acceptance](acceptance/0010-StoryGraph内容图与DAG创作画布验收标准.md) | **当前步骤**：重排 P0–P4，建立 Requirement→实施切片→验收项一一映射，所有目标初始为 `[ ]` | 不编码；历史 `SG-Ixx` 证据不抵扣 |
