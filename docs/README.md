...
| `VP-D06` | [3001 Production Bible](design/3001-项目制作圣经生成执行框架设计.md) | **当前步骤**：固定 Scene Fact → Identity/State 全局调和循环 | 不改 Agent Stage，独立评审与提交前不进入 `VP-D07` |
...
| `0011` | 剧本视觉生产工作台与世界观预设 | — | [跨服务产品设计](design/0011-剧本视觉生产工作台与世界观预设设计.md) | — | — | — | 已接受目标（2026-08-30）；`VP-D01`–`VP-D05` 已完成，当前只解锁 `VP-D06`，不表示已实现 |
