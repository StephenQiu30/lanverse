...
`2002` 的最新增量验收：[Production Bible 持久等待节点](acceptance/2026-WorkflowProductionBible持久等待节点验收记录.md)；前置组合根验收见 [Workflow Worker 组合根](acceptance/2025-WorkflowWorker组合根验收记录.md)。
