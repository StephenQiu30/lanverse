...
最新待评审变更为三份联动设计：[0013 架构调整](design/0013-创作编排与多媒体画布架构调整设计.md) 定义所有权、跨系统交接和迁移；[3004 Agent Harness](design/3004-AgentHarness专业能力与创作流程设计.md) 定义专业能力、上下文、流程与执行合同；[1003 创作画布](design/1003-多媒体创作画布与运行可视化设计.md) 定义节点、分镜组、交互与运行恢复。三份提案尚未取代既有已接受设计，也不改变当前实施队列。接受后按影响范围同步各负责文档。
...
| `0013` | 创作编排与多媒体画布架构调整 | — | [架构调整设计](design/0013-创作编排与多媒体画布架构调整设计.md) | — | — | — | 待评审目标；明确新旧边界、迁移与影响范围，尚未取代既有设计或派生实施计划 |
...
| `1003` | 多媒体创作画布与运行可视化 | — | [画布专项设计](design/1003-多媒体创作画布与运行可视化设计.md) | — | — | — | 待评审目标；联动 0013/3004，定义布局、资源绑定、分镜组、交互、媒体和恢复，尚未实施 |
...
| `3004` | Agent Harness 专业能力与创作流程 | — | [Harness 专项设计](design/3004-AgentHarness专业能力与创作流程设计.md) | — | — | — | 待评审目标；联动 0013/1003，定义 42 项能力、11 类 Flow、任务与上下文、预算修复和画布执行合同，尚未实施 |
