...
| `SG-D20` | [0010 唯一总 Plan](plan/0010-StoryGraph内容图与DAG创作画布实施计划.md) | **当前唯一激活（2026-08-29）**：保持 `SG-I01`–`SG-I19` 历史完成事实，重排剩余 Provider、图片、视频、Canvas 与最终验收任务 | 完成并重新接受前不开始 `SG-D21`、不得领取代码 |
...
| `2051` | 通用媒体 Provider 与 Generation 执行器 | — | [通用媒体 Provider 与执行器设计](design/2051-通用媒体Provider与Generation执行器设计.md) | — | — | — | Design/PRD/Requirement 与 Agent 职责边界已重新接受；等待 `SG-D20`–`SG-D21`，编码仍暂停 |
