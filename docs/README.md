...
| `VP-D11` | [2055 Human Gate](design/2055-Workflow公共HumanGate命令与恢复设计.md) | **当前步骤**：映射五个用户 Gate 的正式 Subject、Decision、Owner Apply 与恢复围栏 | 不改 Workflow Definition；独立评审与提交前不进入 `VP-D12` |
...
| `0011` | 剧本视觉生产工作台与世界观预设 | — | [跨服务产品设计](design/0011-剧本视觉生产工作台与世界观预设设计.md) | — | — | — | 已接受目标（2026-08-30）；`VP-D01`–`VP-D10` 已完成，当前只解锁 `VP-D11`，不表示已实现 |
