...
- 状态：进行中；已完成含世界改编守恒边界的 Backend `PresetRelease`、4 个首批策展 Preset 目录、不可变 `ProjectPresetSelection` 合同、整体 Preset 切换确定性影响闭包、仓库 Skill Bundle 内容身份、八个生产 Input/Candidate Schema、包含视觉调用/结果的统一 Wire Schema、八变体 DefinitionCore/StageRelease、`resolve_visual_foundation` 跨语言严格合同、Agent vision Harness/私有媒体调用入口、Backend 媒体 Broker/HTTP Client、当前 production StoryGraph typed world read-set、Gate 2 exact source、faithful Input compiler、视觉执行生命周期及 GORM 生产持久化，以及三个已采用外部参考的审计与隔离链。视觉执行已复用现有生产 Release/Manifest/Invocation/Attempt/Authorization/Result/Candidate/Head 表，支持精确 fence、accepted replay、`outcome_unknown` 和接收结果前的 SERIALIZABLE 当前输入重编译校验。不表示 Preset Selection 已有 GORM Head/API，也不表示视觉 Stage 已接入 Workflow/Temporal 生产节点或可由产品触发；十三 Stage Core/StageSet、完整 SkillRelease/Control、rewrite eval/shadow/signature、真实 stale 写入、Reference Plan 与 Gate 3 仍未实现。
- Git 基线/提交：本 Visual Foundation 合同切片基线 `0990b2ca1b19cab113de62f3af0b26c4d65cc24d`；SourceMapping 实现提交 `0100fea72a6a7cf82eab8f42dfcf41740a7cb71c`，Preset 守恒合同实现提交 `a795b2da219d40b01e8b8f77863b4a0b7f4b613c`，Preset 切换影响闭包实现提交 `8ed4ed811b3d7af08f3a78a0d8d21c53fab3ab8f`，Visual Foundation 合同实现提交 `7df2903142d1344fc2a4feff1295743c03c99ba2`，图片输入校验实现提交 `093ad57fc3c05de1f3041b1fbffee7842374d39b`，Visual Foundation Harness 实现提交 `77b1b8965f1308506662adbb918093aba344fdb7`，媒体预算实现提交 `463178b639b2fd34c37c77420a6eeeca188dbb32`，Invocation 合同实现提交 `fe59b377c68a4f8d913b555484e19c3a1a35949a`，授权与结果合同实现提交 `f2e10445769a2675a8e3d3e19443fd329c2e2d1c`，视觉 Stage 注册实现提交 `19e13b78c124bab457757f2be659c006a08a361e`，Agent 媒体调用实现提交 `5f8232fa8af503e2f969e900958b8b933b9f46d7`，Backend 媒体传输实现提交 `1fdc5d8e968f15c5a0d7f1167e5b5ade295cbd7d`，首批策展 Preset 目录实现提交 `5fb2c9aeef8e65fafcd0953030d774e038dddc42`，外部能力吸收边界实现提交 `89679cd80e9a2e044fec4554f5250ba3193100f4`，视觉世界读集实现提交 `540a4b040aa5d178a08af817a5b21b8f0b17ea06`，Gate 2 视觉候选来源实现提交 `4bbc0c817c643e6b8b50ae99678dccba2852f101`，faithful 视觉输入编译实现提交 `d2113a9333b6fa297416e572aac8e2b22c68a5ef`，视觉执行生命周期实现提交 `d593b0aa24907ad8d0a93aa142ed21a8059cf6a0`，视觉执行持久化实现提交 `dd83fc26f3a0ed7ea2f1f1f21e772a4cdc0c4d86`，项目 Preset Selection 合同实现提交 `513b6ccc825ce4dfe705c257c7e74e7a975c0460`。
