...
| DEV-S2-02 | StephenQiu30 / in_progress | 12～18 小时 | PT-SCR-001–005 | 已完成版本、提取和候选决议增量；工程门禁已解除，下一步以 Red→Green 实现确认结构；只有用户提供实际 AI 服务配置后才增加对应适配器 | 导入→提取→决议→确认结构可恢复；未配置 AI 服务时明确返回能力不可用，正文不进日志/消息 |
