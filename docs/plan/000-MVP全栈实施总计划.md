...
| S1 | `modules/identity/`、`modules/projects/` | `app/projects/`、`app/workspaces/`、`components/projects/`、Redux/RTK Query Provider | identity/projects 的 unit/integration/contract 与项目入口 E2E |
